...
UNIXFLAGS=-DCCRYPT_DBGFLAGS=ON -DCMAKE_EXPORT_COMPILE_COMMANDS=ON
STATIC_TOOLS=-DCCRYPT_CLANG_TIDY=ON -DCCRYPT_CPPCHECK=ON
ASAN=-DCCRYPT_USE_ASAN=ON
TESTS=-DCCRYPT_TESTS=ON
